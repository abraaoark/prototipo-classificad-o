    ...
    <div class="container">
      <div class="row">
        <div class="p-5 col-md-6" style="">
          <h3 class="mb-3">Finalizar Recuperação</h3>
          <form>
            <div class="form-group"> <label>Nova Senha</label> <input class="form-control" type="text"> </div>
            <div class="form-group"> <label>Confirmar Senha</label> <input type="text" class="form-control"> </div> <button type="submit" class="btn mt-4 btn-block btn-outline-dark p-2"><b contenteditable="true">Alterar<br></b><b></b></button>
          </form>
        </div>
      </div>
    </div>
