  ...
  <div class="py-5" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6 col-lg-3 order-2 order-md-1 p-0"> <img class="img-fluid d-block my-4 img-thumbnail border border-info rounded-lg" src="http://localhost/src/unnamed%20(2).jpg"> </div>
            <div class="d-flex flex-column justify-content-center p-3 col-md-6 offset-lg-1 align-items-start order-1 order-md-2" style="">
              <h3><b><u>Perfil</u></b>:&nbsp;<br><br><b>Nome</b>: Sarah Guimarares de Almeida&nbsp;&nbsp;<br><br><b>Email</b>: Sarah.G85@gmail.com&nbsp;<br><br><b>Telefone</b>: (12) 94002-8922&nbsp;<br><br><b>Profissão</b>: Cuidadora de Idosos</h3>
        ...
        <div class="col-lg-4 p-3">
          <div id="carousel2" class="carousel slide" data-ride="carousel" data-interval="5000">
            <div class="carousel-inner">
              ...
              <div class="carousel-item"> <img class="d-block w-100" src="http://localhost/src/unnamed (2).jpg"> </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center d-md-flex align-items-center"> <i class="fa fa-newspaper-o" aria-hidden="true"></i>
          ...
          <ul class="nav mx-md-auto d-flex justify-content-center">
            <li class="nav-item"> <a class="nav-link" href="index.php">Inicio</a> </li>
            <li class="nav-item"> <a class="nav-link" href="Perguntas.php">Pergunta</a> </li>
