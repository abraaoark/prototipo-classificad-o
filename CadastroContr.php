...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="">
    <div class="container"> <a class="navbar-brand" href="#"><i class="fa fa-newspaper-o" aria-hidden="true"></i>
      ...
      <div class="row">
        <div class="col-md-8  offset-md-1" style=""><a class="btn navbar-btn ml-md-0 btn-light text-dark left:100px; ml-4"href="login.php"  >Login</a></div>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row" style="">
        <div class="mx-auto col-lg-6 col-10">
          ...
          <form class="text-left" method="POST" action="processa2.php">
            <div class="form-group"> <label for="nome_contr" style="">Nome Completo&nbsp;</label> <input type="text" class="form-control" id="nome_contr" name="nome_contr" placeholder="Seu nome" required> </div>
            <div class="form-group"> <label for="´RG_contr">RG<br></label> <input type="text" class="form-control" id="RG_contr" name="RG_contr" placeholder="Seu RG" required> </div>
            <div class="form-group"> <label for="CPF_contr">CPF</label> <input type="text" class="form-control" id="CPF_contr" name="CPF_contr" required>
            ...
            <p>  </p>
            <div class="form-check" style=""> <input class="form-check-input" type="checkbox" id="form21" value="on"> <a href="termo.php"> Ao clicar em cadastrar voce concorda com os termos e condições do serviço</a> </div>
            <div class="form-group">
            </div> <button type="submit" class="btn btn-primary">Cadastrar</a></button>
          </form>
        </div>
      </div>
    </div>
