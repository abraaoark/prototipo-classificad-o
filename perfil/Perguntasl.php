...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center"><u><b>Perguntas Frequentes</b></u></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <p class="mb-4 text-center lead"><u><b>Em relação a nossa plataforma!!</b></u></p>
        </div>
      </div>
    </div>
  </div>
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class=""><u><i><b>Quem nós somos?</b></i></u></h3>
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <blockquote class="blockquote mb-0">
                    <p>Somos a " Classificadão " uma empresa seria e compromissada com o que fazemos. Trabalhamos para criar nossa plataforma com a finalidade de ajudar você trabalhador a divulgar seu serviço.&nbsp;</p>
                    <footer class="blockquote-footer">"" Equipe Classificadão</footer>
                  </blockquote>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="p-3 col-md-6">
          <h3><b><i><u>Porque usar nosso site?</u></i></b></h3>
          <div class="card">
            <div class="card-header">Resposta</div>
            <div class="card-body">
              <blockquote class="blockquote mb-0">
                <p>Nosso site oferece a melhor divulgação da região quando o assunto é divulgar o trabalho de nossos clientes. Trabalhamos com uma plataforma simples para não dificultar a sua experiência em relação a plataforma e ser o máximo funcional possível na hora de divulgar seu serviço.&nbsp;&nbsp;</p>
                <footer class="blockquote-footer">"" Equipe Classificadão</footer>
              </blockquote>
            </div>
          </div>
        ...
        <div class="p-3 col-md-6">
          <h3><b><i><u>O serviço é gratis?</u></i></b></h3>
          <div class="card">
            <div class="card-header">Resposta</div>
            <div class="card-body">
              <blockquote class="blockquote mb-0">
                <p>Em relação as taxas a plataforma oferecera duas formas de utilização sendo uma a gratis e outra paga para mais nformações consulte o setor planos. </p>
                <footer class="blockquote-footer">"" Equipe Classificadão</footer>
              </blockquote>
            </div>
          </div>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="p-3 col-md-12">
          <h3><b><i><u>Quem pode utilizar o serviço?</u></i></b></h3>
          <div class="card">
            <div class="card-header"> Resposta</div>
            <div class="card-body">
              <blockquote class="blockquote mb-0">
                <p>Todo e qualquer trabalhador e toda e qualquer pessoa/empresa que deseje contratar os serviços apresentados pelo site.</p>
                <footer class="blockquote-footer">"" Equipe Classificadão</footer>
              </blockquote>
            </div>
          </div>
