...
<body>
  ...
  <div class="text-center mb-5 pb-5">
    <div class="container">
      ...
      <div class="col-lg-12 col-6 p-5"> <img class="img-fluid col-md-4 col-lg-5  offset-lg-1" src="http://localhost/src/paper3.png">
          <h4> <b>Nossa História</b> </h4>
          <p>Somos a Classificadão uma empresa seria e compromissada com o que fazemos. Trabalhamos para criar nossa plataforma com a finalidade de ajudar você, trabalhador autônomo a divulgar seu serviço. </p>
        </div>
      </div>
    </div>
  </div>
  <div class="py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center d-md-flex align-items-center"> <i class="fa fa-newspaper-o" aria-hidden="true"></i>
          ...
          <ul class="nav mx-md-auto d-flex justify-content-center">
            <li class="nav-item"> <a class="nav-link active" href="indexc.php">Inicio</a> </li>
            <li class="nav-item"> <a class="nav-link" href="Perguntasl.php">Perguntas</a> </li>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="mt-2 mb-0">© 2021 Classificadão</p>
        </div>
      </div>
    </div>
  </div>
