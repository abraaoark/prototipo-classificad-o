    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-12">
          <h1 class="mb-3"><b><u>Cuidador</u>:</b></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-6 col-lg-6 p-4"><a  a href="Perfiluser.php"> <img class="img-fluid d-block mb-3 mx-auto border border-info rounded-lg" src="../src/unnamed (2).jpg" width="200" alt="Card image cap">
          <h4 style='color:Black;' >Cuidadora</h4>
          <p class="mb-3"style='color:Black;' >Sarah Guimarães </p>
          <p class="mb-0"style='color:Black;' >"Olá !! Meu nome é Sarah , sou uma recém cuidadora de idosos. Lembrando que também exerço essa profissão, estando a disposição... </p>
        </div>
        <div class="col-6 col-lg-6 p-4"></div>
      </div>
    </div>
  </div>
  <div class="py-3">
