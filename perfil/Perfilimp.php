  ...
  <div class="py-5" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6 col-lg-3 order-2 order-md-1 p-0"> <img class="img-fluid d-block my-4 img-thumbnail border border-info rounded-lg" src="http://localhost/projeto/default/src/AA-9.png"> </div>
