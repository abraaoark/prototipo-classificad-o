...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container"> <a class="navbar-brand" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar10">
        ...
        </ul> <a class="btn navbar-btn ml-md-2 btn-light text-dark">Login</a>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-10 p-4">
          <p class="mb-4 lead text-light">Suporte Tecnico&nbsp;</p>
          <p class="mb-4 lead text-light">Preencha Os Campos a Baixo</p>
          <form>
            <div class="form-row">
              <div class="form-group col-md-4"> <input type="text" class="form-control" id="form22" placeholder="Nome"> </div>
              <div class="form-group col-md-4"> <input type="email" class="form-control" id="form23" placeholder="Email*"> </div>
              <div class="form-group col-md-4"> <input type="number" class="form-control" id="form24" placeholder="Telefone"> </div>
            </div>
            <div class="form-group"> <input type="text" class="form-control" id="form25" placeholder="Detalhe"> </div>
            <div class="form-group"> <textarea class="form-control" id="form26" rows="3" placeholder="Descreva Um Pouco o seu Problema"></textarea> </div> <button type="submit" class="btn btn-primary">Enviar</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center d-md-flex align-items-center"> <i class="fa fa-envelope-open" aria-hidden="true"></i>
          <b>Classificadão</b>
