    ...
    <div class="container">
      <div class="row">
        <div class="p-5 col-md-6" style="">
          <h3 class="mb-3">Recuperação de Conta <br> </h3>
          <form>
            <div class="form-group"> <label>E-mail</label> <input class="form-control" type="text" placeholder="Digite seu Email" required="required"> </div>
            <div class="form-group"> <label>Conta (Seu Login)</label> <input type="text" class="form-control" required="required"> </div> <button type="submit" class="btn mt-4 btn-block btn-outline-dark p-2"><b contenteditable="true">Recuperar<br></b><b></b></button>
          </form>
        </div>
      </div>
    </div>
