    ...
    <div class="container">
      <div class="row" style="">
        <div class="mx-auto col-md-6 col-10 bg-white p-5 w-50" style="">
          ...
          <form style="" method="POST" action="Login2.php">
            ...
            <button type="submit" class="btn btn-primary mx-2" value="entrar" id="entrar" name="entrar">Entrar</button>
          </form>
          <p>
            </p>
            <form style="" method="POST" action="EscolhaLogin.php">
            </p>
            <button type="submit" class="btn mx-2 btn-secondary" value="op" id="op" name="op" style="" < a href="EscolhaLogin.php" >Outra opções de login</br></a></button>
          </form>
