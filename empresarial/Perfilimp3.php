  ...
  <div class="py-5" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6 col-lg-3 order-2 order-md-1 p-0"> <img class="img-fluid d-block my-4 img-thumbnail border border-info rounded-lg" src="http://localhost/src/AA-9.png"> </div>
            <div class="d-flex flex-column justify-content-center p-3 col-md-6 offset-lg-1 align-items-start order-1 order-md-2" style="">
              <h3><b><u>Perfil</u></b>:&nbsp;<br><br><b>Nome</b>: diskinternet&nbsp;&nbsp;<br><br><b>Email</b>: disk@internet.com&nbsp;<br><br><b>Telefone</b>: (12) 94662-8822&nbsp;<br><br><b>Vaga</b>:Assistente de Ti</h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 p-md-5 p-3 d-flex flex-column justify-content-center">
          <h1><b><u>Serviços Disponivel Pela Empresa</u>:</b></h1>
          <p class="mb-0">"Somos a diskinternet, empresa focada em criar soluções inteligentes, utilizando-se da criatividade e tecnologia para plena satisfação de seus clientes, que, por sua vez, poderão concentrar os esforços nas suas reais necessidades. Temos o compromisso de proporcionar as melhores soluções, porque entendemos que tudo isso só faz sentido se você desfrutar do mundo digital com qualidade" </p>
        </div>
        <div class="col-lg-4 p-3">
          <div id="carousel2" class="carousel slide" data-ride="carousel" data-interval="5000">
            <div class="carousel-inner">
              <div class="carousel-item active"> <img class="d-block w-100" src="http://localhost/src/rote01.png"> </div>
              <div class="carousel-item"> <img class="d-block w-100" src="http://localhost/src/rote02.png"> </div>
            </div>
