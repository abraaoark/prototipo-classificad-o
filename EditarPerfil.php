    ...
    <b>Classificadão</b>
      ...
      <div class="collapse navbar-collapse" id="navbar10">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="Planos.php"><i class="fa fa-credit-card mx-1" aria-hidden="true" style=""></i>Plano<br></a> </li>
      ...
      <div class="row" style="">
        ...
        <div class="col-md-6" style="">
          <form method="POST" action="Upload.php" enctype="multipart/form-data">
            <div class="col-md-3" style=""><img class="img-fluid d-block my-1 mx-1 img-thumbnail" src="http://localhost/src/red.png" style="">
              <div class="col-md-12">
                <button type="submit" class="btn btn-primary" value="Salvar" id="btn1">salvar</button>
              </div>
            </div>
          </form>
        </div>
        <div class="col-md-6">
          <form method="POST" action="upload" enctype="multipart/form-data" id="c_form-h" class="">
