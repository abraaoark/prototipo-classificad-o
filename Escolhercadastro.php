...
<body>
  ...
  <div class="py-5" style="background-image: url(&quot;https://static.pingendo.com/cover-stripes.svg&quot;); background-position: right bottom; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="p-5 bg-white ml-auto col-md-4 border" style="">
          <h1 style="">Anunciante</h1>
          <p class="mb-3">Com esse perfil você conseguirá anunciar seu trabalho na nossa plataforma de forma que contratantes veja e analize seu trabalho para uma possivel contratação!!</p> <a class="btn btn-primary" href="Cadastro.php">Cadastrar</a>
        </div>
        <div class="p-5 bg-white ml-auto col-md-4 border" style="">
          <h1 style="">Contratante</h1>
          <p class="mb-3">Com esse perfil você poderá ver e analizar diversos perfis para contrata-los</p> <a class="btn btn-primary" href="CadastroContr.php" style="">Cadastrar</a>
        </div>
        <div class="p-5 bg-white ml-auto col-md-4 border" style="">
          <h1 style="">Empresa</h1>
          <p class="mb-3">Com esse perfil você poderá ver e analizar diversos perfis para sua empresa!!&nbsp;</p> <a class="btn btn-primary" href="CadastroEMP.php" style="">Cadastrar</a>
        </div>
      </div>
    </div>
  </div>
