    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-12">
          <h1 class="mb-3"><b><u>Serviços Domesticos</u>:&nbsp;</b></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-6 col-lg-6 p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="src/117261-8-dicas-para-contratar-uma-empresa-de-limpeza-e-conservacao.jpg" width="200" alt="Card image cap">
          <h4><b>Limpador de Vidros&nbsp;</b></h4>
          <p class="mb-3"><b>Marco Ribeiro</b></p>
          <p class="mb-0" style="">Salve salve familia, meu vulgo é Marquin da limpeza e recentemente mudei para Cruzeiro-SP e estou...</p>
        </div>
        <div class="col-6 col-lg-6 p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="src/terceirizacao-de-servicos-de-limpeza.jpg" width="200" alt="Card image cap">
          <h4><b>Doméstica</b></h4>
